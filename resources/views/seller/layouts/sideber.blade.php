                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu">
                            <li class="active">
                                <a href="{{route('seller')}}" class="has-arrow"> <span>Dashboard</span></a>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="{{ route('seller_product.index') }}">All Product</a></li>
                                    <li><a href="{{ route('seller_product.create') }}">Create Product</a></li>
                                </ul>
                            </li>
