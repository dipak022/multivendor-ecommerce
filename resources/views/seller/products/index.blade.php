            ...
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        ...
                        <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                        <a class="btn btn-success" href="{{route('seller_product.create')}}">Add Product</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('seller_product.show',$item->id)}}"  class="btn btn-info" href="#defaultModal" ><i class="float-left fa fa-plus"></i></a>
                                            ...
                                            <a type="button" href="{{route('seller_product.edit',$item->id)}}" class="btn btn-info" title="Edit"><i class="float-left fa fa-edit"></i></a>
                                            <form class="float-left px-2" action="{{ route('seller_product.destroy',$item->id) }}" method="POST">
                                                @csrf 
                                                @method('delete')
