        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        ...
                        <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                        <a class="btn btn-success" href="{{route('seller_product.index')}}">All Product</a>
                        </div>
                    </div>           
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="body">
                        <form class="add-contact-form" method="post" action="{{ route('seller_product.store') }}" enctype="multipart/form-data">
                             @csrf
