        ...
        <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
                            <h3 > Total Category :{{\App\Models\Category::count()}} </h3>
                        </div>
                        <div class="inlineblock text-center m-r-15 m-l-15 hidden-sm">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>Category Information List </h2>                            
                        </div>
                        <div class="body">
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" href="{{route('category.edit',$item->id)}}" class="btn btn-info" title="Edit"><i class="float-left fa fa-edit"></i></a>
